...
p <- ggplot(df_anim, aes(x = Hour, y = Average_Ridership)) +
  geom_bar(stat = "identity", fill = "steelblue") +
  labs(title = "Weekday Average Ridership per Hour – UVA Stops",
...
final_frame <- image_read("final_frame.png")
...
image_write_gif(all_frames, "comb_uva_histogram.gif", delay = 0.3, loop=0)
